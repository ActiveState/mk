...
class bugs(Task):
    ...
    def make(self):
        webbrowser.open("http://github.com/ActiveState/mk/issues")

class site(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://github.com/ActiveState/mk")

class pypi(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://pypi.python.org/pypi/mk/")
...
class cut_a_release(Task):
    ...
    """
    proj_name = "mk"
    version_py_path = "mklib/__init__.py"
    version_module = "mklib"
...
class pypi_upload(Task):
    ...
    def make(self):
        ...
        url = "http://pypi.python.org/pypi/mk/"
        import webbrowser
